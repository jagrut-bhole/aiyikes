...
import { AuthSchemaRequest, AuthSchema } from "@/types/authSchema/AuthSchema";
import { toast } from "sonner";
import { registerUser } from "@/apis/auth/authApi";
...
export default function RegisterPage() {
    ...
    const registerUserSchema = AuthSchema.pick({
        name: true,
        email: true,
        password: true,
    });
