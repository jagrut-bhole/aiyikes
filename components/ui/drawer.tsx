...
function DrawerOverlay({
    ...
    return (
        <DrawerPrimitive.Overlay
            ...
            className={cn(
                "data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 bg-black/80 fixed inset-0 z-50 backdrop-blur-sm",
                className
            )}
            {...props}
        />
    ...
    return (
        <DrawerPortal data-slot="drawer-portal">
            ...
            <DrawerPrimitive.Content
                ...
                className={cn(
                    "group/drawer-content bg-[#0a0a0a] border-neutral-800 fixed z-50 flex h-auto flex-col",
                ...
                {...props}
            >
                <div className="bg-neutral-700 mx-auto my-2 hidden h-1.5 w-16 shrink-0 rounded-full group-data-[vaul-drawer-direction=bottom]/drawer-content:block" />
                {children}
            </DrawerPrimitive.Content>
        </DrawerPortal>
    );
...
function DrawerHeader({ className, ...props }: React.ComponentProps<"div">) {
    return (
        <div
            ...
            className={cn(
                "flex w-full flex-col gap-1 rounded-t-3xl border-b border-neutral-800 px-4 py-3 md:mx-auto md:max-w-md",
                className
            )}
            {...props}
        />
...
function DrawerFooter({ className, ...props }: React.ComponentProps<"div">) {
    return (
        <div
            ...
            className={cn(
                "mt-auto grid w-full gap-2 border-t border-neutral-800 px-4 py-3 md:mx-auto md:max-w-md",
                className
            )}
            {...props}
        />
